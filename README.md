...
Facet-счётчики считаются не по всей базе, а по текущему отфильтрованному набору. Это делает sidebar полезным: когда меняется поиск или фильтр, top-20 hobbies и nationalities сразу подстраиваются под новую выдачу.
